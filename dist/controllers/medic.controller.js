...
var postDoctor = exports.postDoctor = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$user, _req$body, name, lastname, age, speciality, direction, consultory, telephone, userId, existingDoctor, newDoctor;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          userId = ((_req$user = req.user) === null || _req$user === void 0 ? void 0 : _req$user.id) || req.body.user; // Se asume que el usuario autenticado está en req.user
  ...
  return function postDoctor(_x3, _x4) {
...
var deleteMedic = exports.deleteMedic = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.prev = 1;
          _context4.next = 4;
          return _doctor["default"].findByIdAndDelete(id);
        case 4:
...
var getDoctorPatients = exports.getDoctorPatients = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var id, searchTerm, doctor, query, patients;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          id = req.params.id; // ID del doctor
          searchTerm = req.query.searchTerm; // Término de búsqueda opcional
          // Verificar si el doctor existe
          _context5.next = 5;
          return _doctor["default"].findById(id).populate("pacientes");
        case 5:
        ...
        case 8:
          ...
          }; // Filtra solo los pacientes de este doctor
          ...
          _context5.next = 12;
          return _patient["default"].find(query);
        case 12:
