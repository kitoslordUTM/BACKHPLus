...
exports.updatePatient = exports.postPatient = exports.getPatients = exports.getPatientByUserId = exports.getDoctorPatientByUserId = void 0;
...
var getPatients = exports.getPatients = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var searchTerm, query, patients;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 6;
          return _patient["default"].find(query).populate("user", "name lastname email") // Traer información del usuario
          .populate("doctor", "name lastname speciality");
        case 6:
  ...
  return function getPatients(_x, _x2) {
...
var postPatient = exports.postPatient = /*#__PURE__*/function () {
      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return _context2.abrupt("return", res.status(400).json({
            message: "All fields are required, including user and doctor"
          }));
        case 4:
          newPatient = new _patient["default"]({
            name: name,
            lastname: lastname,
            age: age,
            gender: gender,
  ...
  return function postPatient(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

// Actualizar paciente parcialmente
var updatePatient = exports.updatePatient = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var id, updates, patient;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          id = req.params.id;
          updates = req.body; // Buscar al paciente
          _context3.next = 5;
          return _patient["default"].findById(id);
        case 5:
...
var getPatientByUserId = exports.getPatientByUserId = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          userId = req.params.userId; // Buscar al paciente por userId y poblar la relación con el doctor
          _context4.next = 4;
        ...
        case 10:
          ...
          console.error("Error al obtener el paciente:", _context4.t0);
          res.status(500).json({
  ...
  return function getPatientByUserId(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var getDoctorPatientByUserId = exports.getDoctorPatientByUserId = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          userId = req.params.userId; // Buscar el paciente por userId y popular la información del doctor
          _context5.next = 4;
          return _patient["default"].findOne({
            user: userId
          }).populate({
        ...
        case 10:
          ...
          console.error("Error fetching patient by userId:", _context5.t0);
          res.status(500).json({
  ...
  return function getDoctorPatientByUserId(_x9, _x10) {
